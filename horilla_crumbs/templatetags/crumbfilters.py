...
# else (company names, object reprs such as an employee's full name) is dynamic
# content and must be left untouched.
...
def crumb_label(name):
    ...
    (payroll, recruitment, ...) still translate. Dynamic content is returned
    unchanged.
    """
